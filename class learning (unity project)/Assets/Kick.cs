       ...
       if (Input.GetButtonDown("Fire1") == true)
        {
           ...
           Debug.DrawRay(transform.position, transform.forward * kickDist, Color.green, 1.5f);//Draw interaction ray from camera
           if (Physics.Raycast(transform.position,transform.forward, out RaycastHit hit, kickDist) ==true )//raycast in foward direction from camera postion
            {
